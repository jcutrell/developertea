  ...
  return (
    <div {...rest} tw={"relative text-left items-center bg-white"}>
      ...
      <button
        ...
        tw={
          "border-2 border-blue-100 text-brandBlue-800 py-2 px-3 rounded-md text-xs m-8 mt-0 hover:bg-brandBlue-600 hover:text-white hover:border-brandBlue-600"
        }
      >
        <svg
          version="1.1"
      ...
      <Link href={episode.enclosure_url}>&darr; Download this Episode</Link>
    </div>
  );
}
